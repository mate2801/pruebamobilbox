   ...
   <div class="container" >
    <div class="row">
		<div class="span7 offset5">
			<form class="form-center" id="registroNoticia" method="post" enctype="multipart/form-data">
			  <fieldset>
			    <div id="legend">
			      <legend class="">Registro noticia </legend>
                </div>
			    ...
			    <div class="control-group">
			      ...
			      <div class="controls">
              <button id="submit" type="button" class="btn btn-success">Registrar</button>
...
$( function () {
    $('#submit').click( function () {
        ...
        var formData = new FormData($("#registroNoticia")[0]);
         var ruta = "<?php echo constant('URL')?>publicarnoticia/validarNoticia";
        ...
        $.ajax({
            ...
            success:function (respuesta) {
                $('#loading').hide();
                if (respuesta == 1) {
                    $('#mensajes').html("Noticia agregada con exito!");
